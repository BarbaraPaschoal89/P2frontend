...
export default class Main extends Component {
    ...
    componentDidMount() {
        fetch(`https://pp1backend.herokuapp.com/produto/`)
            .then(produto =>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Quant_em_Estoque</th>
                    ...
                    <tbody>
                        {produto.map((produto, index) => (
                            <tr>
                                ...
                                <td>{produto.quantemEstoque.toLocaleString('pt-BR', {maximumSignificantDigits: 5 })}</td>
